                ...
                switch (effectName)
                {
                    ...
                    case "Sacrifice":
                        ...
                        if (manager.enemyField.Count == 3 && manager.playerField.Count == 3)
                        {
                            ...
                            hand.Remove(c);
                            RenderEffectCard(c);
                            yield return StartCoroutine(manager.effects.Sacrifice("Enemy", 4));
                            yield return new WaitForSeconds(2f);
                            EraseCard(c);
                        }
                        break;
                    case "Shadow Strike":
                        if (manager.playerField.Count >= 1)
                        {
                            ...
                            hand.Remove(c);
                            RenderEffectCard(c);
                            yield return StartCoroutine(manager.effects.ShadowStrike("Enemy", 4));
                            yield return new WaitForSeconds(2f);
                            EraseCard(c);
                        }
                        break;
                    ...
                    case "Aggression":
                        ...
                        if (aggroRand == 3 && nonAggroCreatureOnField && battleReadyOnField)
                        {
                            ...
                            hand.Remove(c);
                            RenderEffectCard(c);
                            yield return StartCoroutine(manager.effects.Aggression("Enemy", 4));
                            yield return new WaitForSeconds(2f);
                            EraseCard(c);
                        }
                        break;
                    ...
                    case "Shield":
                        ...
                        if (shieldRand == 3 && nonShieldedCreatureOnField)
                        {
                            ...
                            hand.Remove(c);
                            RenderEffectCard(c);
                            yield return StartCoroutine(manager.effects.Shield("Enemy", 4));
                            yield return new WaitForSeconds(2f);
                            EraseCard(c);
                        }
                        break;
