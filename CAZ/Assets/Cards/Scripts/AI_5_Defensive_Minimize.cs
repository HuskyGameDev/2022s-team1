...
public class AI_5_Defensive_Minimize : AI_Standard
{
                ...
                switch (effectName)
                {
                    ...
                    case "Sacrifice":
                        ...
                        if (manager.enemyField.Count == 3 && manager.playerField.Count == 3)
                        {
                            ...
                            hand.Remove(c);
                            RenderEffectCard(c);
                            yield return StartCoroutine(manager.effects.Sacrifice("Enemy", 5));
                            yield return new WaitForSeconds(2f);
                            EraseCard(c);
                        }
                        break;
                    case "Shadow Strike":
                        if (manager.playerField.Count >= 1)
                        {
                            ...
                            hand.Remove(c);
                            RenderEffectCard(c);
                            yield return StartCoroutine(manager.effects.ShadowStrike("Enemy", 5));
                            yield return new WaitForSeconds(2f);
                            EraseCard(c);
                        }
                        break;
                    ...
                    case "Aggression":
                        ...
                        if (aggroRand == 3 && nonAggroCreatureOnField)
                        {
                            ...
                            hand.Remove(c);
                            RenderEffectCard(c);
                            yield return StartCoroutine(manager.effects.Aggression("Enemy", 5));
                            yield return new WaitForSeconds(2f);
                            EraseCard(c);
                        }
                        break;
                    case "Revive":
                        ...
                        if (discarded.Count > 0 && hand.Count < 3)
                        {
                            ...
                            hand.Remove(c);
                            RenderEffectCard(c);
                            manager.effects.Revive("Enemy", 5);
                            yield return new WaitForSeconds(2f);
                            EraseCard(c);
                        }
                        break;
                    case "Shield":
                        ...
                        if (shieldRand == 3 && nonShieldedCreatureOnField)
                        {
                            ...
                            hand.Remove(c);
                            RenderEffectCard(c);
                            yield return StartCoroutine(manager.effects.Shield("Enemy", 5));
